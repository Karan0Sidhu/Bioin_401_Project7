...
import os
import shutil
Tag_Threshold = 750 # at minimum the first 1000 words need

# first test: thresh = 750  --> 750/5000 = 15% of inital 1000 word text must be tagged-------------------------
